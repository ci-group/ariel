...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Replace CPPN-derived brick lengths with independent uniform samples "
            "from the configured valid brick-length range."
        ),
    )
...
def main() -> None:
    ...
    if args.save_graphs:
        graphs_file = (args.output / "graphs.jsonl").open(
            "w",
            encoding="utf-8",
        )
    ...
    try:
        while accepted < args.target_valid and attempts < args.max_attempts:
            ...
            if (
                ...
                and accepted % args.progress_every == 0
            ):
                ...
                print(
                    ...
                    f"({acceptance_rate:.2%} acceptance, "
                    f"{rate:.1f} valid robots/s)"
                )
    ...
    summary = {
        ...
        "uniform_lengths": args.uniform_lengths,
    ...
    print()
    print(
        f"Finished: {accepted:,} valid robots "
    ...
    print(
        f"Uniform lengths: {args.uniform_lengths}"
    )
    print(
