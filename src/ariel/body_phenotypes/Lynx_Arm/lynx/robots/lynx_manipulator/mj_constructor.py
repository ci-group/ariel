...
from ariel.body_phenotypes.Lynx_Arm.lynx.robots.lynx_manipulator.modules.mj_base import MjBase
from ariel.body_phenotypes.Lynx_Arm.lynx.robots.lynx_manipulator.modules.mj_bspline_tube import (
    MjBSplineTubeWithClamps,
)
from ariel.body_phenotypes.Lynx_Arm.lynx.robots.lynx_manipulator.modules.mj_end_effector import (
    MjEndEffector,
)
from ariel.body_phenotypes.Lynx_Arm.lynx.robots.lynx_manipulator.modules.mj_joint import (
    MjJointInline,
    MjJointOrthogonal,
)
from ariel.body_phenotypes.Lynx_Arm.lynx.robots.lynx_manipulator.modules.mj_tube import MjTube
...
def construct_lynx(
    ...
    if robot_description_dict is None:
        robot_description_dict: dict = {
            ...
            "num_segments": 100,
            "clamp_stl": str(CWD / "src/ariel/body_phenotypes/Lynx_Arm/models/clamp_0205.stl"),
        }
    ...
    tube1 = MjBSplineTubeWithClamps(
        ...
        clamp_stl=robot_description_dict.get("clamp_stl", str(CWD / "src/ariel/body_phenotypes/Lynx_Arm/models/clamp_0205.stl")),
    )
