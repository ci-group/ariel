...
class SimpleFlatWorld:
    ...
    def spawn(self, other_spec) -> None:
        ...
        # Optional mesh preload for clamp visuals. Disabled by default so tube
        # geometry can be inferred without STL files.
        use_clamp_meshes = os.environ.get("LYNX_USE_CLAMP_STL", "0") == "1"
        if use_clamp_meshes:
            mesh_files = [
